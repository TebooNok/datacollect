$(document).ready(function(){
    ...
    var testdata2 = [
        {'a':'重要','b':'1号上行','c':'2018-04-11','d':'已处理','e':'李白','f':'2018-04-14','g':'--','h':'--','i':'-這個備注很長很長很長很很長很長估計要1000個000000字-'},
    ...
    $('#testtable3').yhhDataTable({
        ...
        'tbodyRow':{
            'zebra':true,
            'write':function(d){
                return '<tr><td>'+d.a+'</td><td>'+d.b+'</td><td>'+d.c+'</td><td>'+d.d+'</td><td>'+d.e+'</td><td>'+d.f+'</td><td>'+d.g+'</td><td>'+d.h+'</td><td>'+d.h+'</td><td><p class="noWord">'+d.i+'</p></td><td> <div> \n' +
                    '                 <input title="查看详情" type="button"  class="btn btn-primary backSearch police_caozuo" data-attr=\''+JSON.stringify(d)+'\' onclick="edit(this)"/>' +
                    '                 <input title="管理员确认" type="button"  class="btn btn-primary admins police_caozuo" onclick="guanl(this)"/>' +
                    '				<input title="高级管理员确认" type="button"  class="btn btn-primary Higeradmins police_caozuo" onclick="heiguanli(this)"/>' +
                    '                 <input title="删除" type="button"   class="btn btn-danger police_del police_caozuo" onclick="del(\''+d.a+'\')"/>' +
                    '             </div> </td></tr>';
            }
        },
        'tbodyData':{
